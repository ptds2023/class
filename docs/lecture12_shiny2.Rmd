...
subtitle: "Lecture #11: advanced {shiny}"
author: "Samuel Orso"
...
* The parent of the base namespace if the global environment.
...
* To use this tool:
  1. Open Chrome-based browser in incognito mode (so the experience is a neutral as possible).
