...
* Distributing code with other users.
...
Encoding: UTF-8
LazyData: true
URL: https://https://github.com/ptds2022/pkgtest
BugReports: https://https://github.com/ptds2022/pkgtest/issues
RoxygenNote: 7.1.2
```
...
---
# A simple example
* Suppose you want to make the `supermarket_sales.csv` data available to the users.
...
---
Find all the code presented here: <https://github.com/ptds2022/pkgtest>
...
* Add the `supermaket` dataset from HW2 to the package (keep the raw data, create a `.rda` file, document the dataset).
