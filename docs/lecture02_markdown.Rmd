...
- It combines functionalities of RMarkdown and other packages into a **single system**, very useful to collaborate people who write in a different programming language from you (and do not necessarily have R/R Studio).
...
1. Try to make it into a Quarto document.
